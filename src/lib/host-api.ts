...
export const hostApi = {
  ...
  skills: {
    ...
    marketplaceCapability: () => invokeHost('skills', 'marketplaceCapability'),
    marketplaceList: () => invokeHost('skills', 'marketplaceList'),
    marketplaceSearch: (input: MarketplaceSearchPayload) => invokeHost('skills', 'marketplaceSearch', input),
    marketplaceInstall: (input: MarketplaceInstallPayload) => invokeHost('skills', 'marketplaceInstall', input),
    marketplaceUninstall: (input: MarketplaceUninstallPayload) => invokeHost('skills', 'marketplaceUninstall', input),
    ...
    clawhubInstall: (input: MarketplaceInstallPayload) => invokeHost('skills', 'clawhubInstall', input),
