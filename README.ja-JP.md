...
プレゼンテーション計画には、再現可能なデザイン仕様も保持されます。製品発表、旅行ストーリー、経営レポート、研修資料、一般的な編集ストーリーでは、異なるテーマファミリー、表紙構成、ページフレーム、コンテンツレイアウトを選択します。複合ランタイム、直接の `create_pptx_file` ツール、内蔵フォールバックは同じ意味的テーマ体系を使い、異なる題材を一つの固定テンプレートへ押し込みません。
