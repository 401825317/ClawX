import {
  JUNFEIAI_VIDEO_GENERATION_DEFAULT_MODEL,
  JUNFEIAI_VIDEO_GENERATION_DEFAULT_SIZE,
  JUNFEIAI_VIDEO_GENERATION_DEFAULT_SIZES,
  JUNFEIAI_VIDEO_GENERATION_IMAGE_TO_VIDEO_MODEL,
  JUNFEIAI_VIDEO_GENERATION_PROVIDER_KEY,
  JUNFEIAI_VIDEO_GENERATION_TIMEOUT_MS,
} from '../../shared/junfeiai-endpoints';

export const CLAWX_OPENAI_VIDEO_PROVIDER_KEY = JUNFEIAI_VIDEO_GENERATION_PROVIDER_KEY;
export const CLAWX_OPENAI_VIDEO_DEFAULT_MODEL = JUNFEIAI_VIDEO_GENERATION_DEFAULT_MODEL;
export const CLAWX_OPENAI_VIDEO_15_MODEL = JUNFEIAI_VIDEO_GENERATION_IMAGE_TO_VIDEO_MODEL;
...
export const CLAWX_OPENAI_VIDEO_DEFAULT_SIZE = JUNFEIAI_VIDEO_GENERATION_DEFAULT_SIZE;
export const CLAWX_OPENAI_VIDEO_DEFAULT_SIZES = [...JUNFEIAI_VIDEO_GENERATION_DEFAULT_SIZES];
