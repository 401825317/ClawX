...
describe('openclaw-image-generation helpers', () => {
  ...
  it('normalizes chat image models to the managed OpenAI image relay', async () => {
    ...
    expect(IMAGE_GEN_CHAT_DEFAULT_TIMEOUT_MS).toBe(1_800_000);
    expect(resolveChatImageTimeoutMs(null)).toBe(1_800_000);
    expect(resolveChatImageTimeoutMs(120_000)).toBe(1_800_000);
    expect(resolveChatImageTimeoutMs(300_000)).toBe(1_800_000);
